...
if page == "first":
    ...
    summarization_client = nlpcloud.Client("finetuned-llama-3-70b", "your_api_key_here", gpu=True)
    sentiment_client = nlpcloud.Client("distilbert-base-uncased-emotion", "your_api_key_here", gpu=False)
